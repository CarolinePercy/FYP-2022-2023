// Example MLP network using the MNIST data.
// Source: https://github.com/pimlu/cppnn
//
// ConsoleMLP.cpp : Defines the entry point for the console application.
//
...
using namespace Eigen;	//http://eigen.tuxfamily.org/index.php?title=Main_Page
using namespace std;
